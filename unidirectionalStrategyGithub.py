...
def uds_raw_data():
    ...
    niftydf = pd.read_csv (r'C:\Users\sukhw\OneDrive\Documents\TradingStrategy\NSE500.csv')  
    ...
    # # Export the data
    candledffinal.to_csv (r'C:\Users\sukhw\OneDrive\Documents\TradingStrategy\files\candledata_{}.csv'.format(today), index = None, header=True)
